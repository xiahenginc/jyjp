...
function addToCart(goodsId, parentId,numid,isDirect)
{
  ...
  goods.isDirect =(typeof(isDirect) == "undefined") ? 0 : parseInt(isDirect);
    ...
    else
    {
      ...
      switch(result.confirm_type)
      {
        case '1' :
		  ...
		  document.getElementById("caropenwindows").style.display = "";
          break;
        case '2' :
          //if (!confirm(result.message)) location.href = cart_url;
		  document.getElementById("caropenwindows").style.display = "";
